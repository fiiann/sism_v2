...
<body>
  ...
  <h6 align='right'><a href="tambah_mekanik.php"><button class="btn btn-info">Tambah Mekanik</button></a></h6>
	...
	$query = "SELECT * from mekanik m INNER JOIN section s ON m.id_section=s.id_section";
	// Execute the query
    ...
    echo "<td>".$row->nama_section."</td>";
		echo "<td align='center'><a href='delete_mekanik.php?id=".$row->id_mekanik."'><i class='fa fa-book'></i></a>&nbsp<a href='edit_mekanik.php?id=".$row->id_mekanik."'><i class='fa fa-edit'></i></a>&nbsp</td>";
	}
	?>
    </tbody>
	</table>
