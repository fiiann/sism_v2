...
?>
<body>
	<h3>Experience Mekanik Wheel</h3>
	...
	$query = "SELECT *, COUNT(*) as jumlah from work_order w INNER JOIN mekanik m ON w.mekanik1=m.id_mekanik WHERE m.id_section='1' GROUP BY w.mekanik1";
	// Execute the query
