...
<html>
<head>
	<title>Daftar Experience Mekanik wheel</title>
...
?>
<body>
	<h3>Experience Mekanik Crusher</h3>
	...
	$query = "SELECT *, COUNT(*) as jumlah from work_order w INNER JOIN mekanik m ON w.mekanik1=m.id_mekanik WHERE m.id_section='4' GROUP BY w.mekanik1";
	// Execute the query
